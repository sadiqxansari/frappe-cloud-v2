<template>
  <CentralShell :crumbs="[{ label: 'Servers', route: '/servers' }, { label: 'New server' }]" wide>
    ...
    <div class="flex min-h-0 flex-col-reverse lg:h-[calc(100vh-50px)] lg:flex-row-reverse">
      <!-- Map (right) -->
      <div class="border-t border-outline-gray-1 p-4 lg:flex-1 lg:border-l lg:border-t-0">
        <div class="relative h-72 w-full overflow-hidden rounded-xl border border-outline-gray-2 bg-surface-gray-1 lg:h-full">
          ...
          <div class="absolute bottom-3 right-3 flex flex-col overflow-hidden rounded-lg border border-outline-gray-2 bg-surface-white shadow-sm">
            ...
            <button class="grid size-8 place-items-center border-t border-outline-gray-1 text-ink-gray-6 hover:bg-surface-gray-2" aria-label="Zoom out" @click="zoom(-0.4)">
