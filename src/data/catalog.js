...
export const PLANS = [
  {
    ...
    specs: { database: '250 MB', disk: '2 GB' },
    featured: true,
    recommended: true,
  },
  {
    ...
    specs: { database: '500 MB', disk: '5 GB' },
    featured: true,
    recommended: false,
  },
  {
    ...
    specs: { database: '1 GB', disk: '25 GB' },
    featured: false,
    recommended: false,
  },
  {
    ...
    specs: { database: '2 GB', disk: '50 GB' },
    featured: true,
    recommended: false,
  },
  {
    ...
    specs: { database: '3 GB', disk: '75 GB' },
    featured: false,
    recommended: false,
    enterprise: true,
  },
  {
    ...
    specs: { database: '4 GB', disk: '100 GB' },
    featured: false,
    recommended: false,
    enterprise: true,
  },
  {
    ...
    specs: { database: '8 GB', disk: '200 GB' },
    featured: false,
    recommended: false,
    enterprise: true,
  },
