<template>
  <div class="flex items-center justify-between gap-2" @paste="onPaste">
    <input
      ...
      class="h-12 w-full rounded-lg border border-outline-gray-3 bg-surface-elevation-1 text-center text-lg font-semibold text-ink-gray-9 outline-none transition-colors focus:border-outline-gray-4 focus:ring-2 focus:ring-outline-gray-3"
